...
date_default_timezone_set('Asia/Manila');
	...
	if(isset($_POST['savechanges']))
    {
        ...
        $supervisorid = $_POST['savesupid'];
        $prevsupid = $_POST['prevsupid'];

        $saveid = $_POST['saveid'];

        $updatesql="UPDATE account SET fname = '$fname', lname = '$lname', idnumber = '$idnumber', supervisorid = '$supervisorid' WHERE idnumber='$saveid'";
        $updatequery = $dbh->prepare($updatesql);
        $updatequery->execute();

        if ($prevsupid != $supervisorid) {
            $action = "New Supervisor: \nID Number - ".$idnumber."\nSup. ID Number - ".$prevsupid." -> ".$supervisorid;
            include('addtolog.php');
        }
        else{
	...
	if(isset($_POST['btnmakesup']))
	{
        ...
        $updatesql="DELETE FROM productivity WHERE idnumber='$idnumber'";
        $updatequery = $dbh->prepare($updatesql);
        $updatequery->execute();

	    $sql="INSERT INTO account(idnumber,fname,lname,accpass,issupervisor) VALUES(:saveid,:fname,:lname,:accpass,1)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':saveid',$saveid,PDO::PARAM_STR);
        $query->bindParam(':fname',$fname,PDO::PARAM_STR);
        $query->bindParam(':lname',$lname,PDO::PARAM_STR);
        $query->bindParam(':accpass',$accpass,PDO::PARAM_STR);
        $query->execute();

        $action = "Promoted employee to supervisor: \nID Number - ".$idnumber;
		include('addtolog.php');
...
<html lang="en">
    ...
    <body class="sb-nav-fixed" style="background-color: #F5F5F5">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-flex">
                        ...
                        <h1 class="mt-3" style="font-size: 30px;color: #621299; margin-bottom: 0">Manage Employees</h1>
                        <style>
                            hr.solid {
                        ...
                        <hr class="solid">
                                        ...
                                        <div class="card-body" style="padding:10px">
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <table id="example3" class="display table table-striped" cellspacing="0" width="100%" style="table-layout:fixed;">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <?php $sql="SELECT * FROM account WHERE issupervisor = 0 ORDER BY status ASC";
                                                            $query = $dbh->prepare($sql);
                                                            $query->execute();
                                                            ...
                                                            foreach($results as $result)
                                                                ...
                                                                <td>
                                                                    ...
                                                                    '<?php echo $finalsupid;?>',
                                                                    '<?php echo htmlentities($result->supervisorid);?>',
					    ...
					    <div class="modal-content">
                                <form method="POST">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control py-4" id="lname" name="lname" type="input" required/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="small mb-1 " for="btnmakesup">Other</label>
                                            <button type="submit" id="btnmakesup" name="btnmakesup" class="btn btn-warning form-control">Promote to Supervisor</button>
                                        </div>
                                        <div class="form-group">
                                                <button type="submit" id="btnstatus" name="btnstatus" class="btn btn-warning form-control">Activate</button>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="hidden" id="prevsupid" name="prevsupid" value="0"/>

                                        <button type="button" class="btn btn-info mr-auto" onclick="location.href='gethistoryemp.php'">History</button> 
        ...
        <script>
            ...
            function editInfo(fname,lname,idnumber,supervisorname,supervisorid,status) {
                ...
                document.getElementById("prevsupid").value = supervisorid;

                document.cookie="empID="+idnumber;

                if (status == "Active") {
                    document.getElementById("btnstatus").innerHTML = "Deactivate";
                    document.getElementById("savestatus").value = "Activate";
                }
                else{
                    document.getElementById("btnstatus").innerHTML = "Activate";
