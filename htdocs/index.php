...
<?php
    ...
    //echo '<script>alert("'.$yeartoday.'")</script>';
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <div class="container-fluid" >
                        <h1 class="mt-3" style="font-size: 30px;color: #621299; margin-bottom: 0">Dashboard</h1>
                        <style>
                            hr.solid {
                        ...
                        <div class="row container-flex">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-1">
                                    <div class="card-body center" style="font-size: 14px"> View Teams</div>
                                    <a class="small text-white stretched-link" href="orgchart.php"></a>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-1">
                                    <div class="card-body center" style="font-size: 14px">Set Productivity Level</div>
                                    <a class="small text-white stretched-link" href="recordhours.php"></a>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body center" style="font-size: 14px">View Productivity</div>
                                    <a class="small text-white stretched-link" href="viewproductivity.php"></a>
                                </div>
                            </div>
                            <!--<div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body center" style="font-size: 14px">Weekly Reports</div>
                                    <a class="small text-white stretched-link" href="weeklyreport.php"></a>
                                </div>
                            </div>-->
                        </div>  
                    ...
                    // 1 , 5 , 6 , 4 , 0 , 2 , 3
                    // 4,0,5,6,3,1,2
                    $dayoftheweekdate = array("Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday");
                    $count = 0;
                    if($countquery->rowCount() > 0)
                    {
                        foreach($countresults as $countresult)
                        {
                            ...
                            //$dayoftheweekdate[$dayoftheweekindex[$count]] = date('m/d/Y', strtotime(htmlentities($countresult->yearnumber)."W".htmlentities($countresult->weeknumber).htmlentities($countresult->dayoftheweek)));
                            //echo '<script>alert("'.date('m/d/Y',strtotime("2021"."W"."8"."Tuesday")).'")</script>';
                            //echo '<script>alert("'.date('m/d/Y', strtotime(htmlentities($countresult->yearnumber)."W".htmlentities($countresult->weeknumber).htmlentities($countresult->dayoftheweek))).'")</script>';
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                ...
                                <table id="example3" class="display table table-striped table-responsive" cellspacing="0" width="100%" style="font-size: 12px">
